<div class="exception">
    ...
    <div class="exc-message">
        ...
        <ul class="search-for-help">
            <?php if (!empty($docref_url)): ?>
                <li>
                    <a rel="noopener noreferrer" target="_blank" href="<?php echo $docref_url; ?>" title="Search for help in the PHP manual.">
                        ...
                        <svg height="16px" id="Layer_1" style="enable-background:new 0 0 32 32;" version="1.1" viewBox="0 0 32 32" width="16px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g transform="translate(240 0)">
            ...
            <?php endif ?>
            <li>
                <a rel="noopener noreferrer" target="_blank" href="https://www.baidu.com/s?wd=<?php echo urlencode(implode('\\', $name) . ' ' . $message) ?>" title="Search for help on Baidu.">
                    <!-- Stack Overflow icon by webalys, from https://www.iconfinder.com/webalys -->
                    <!-- Free for commercial use -->
                    <svg enable-background="new 0 0 100 100" height="16" viewBox="0 0 100 100" width="16" xmlns="http://www.w3.org/2000/svg">
        ...
        <span id="plain-exception"><?php echo $tpl->escape($message) ?></span>
